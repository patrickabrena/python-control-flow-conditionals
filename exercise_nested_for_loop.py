...
#for steps 1 and 2 and 3
for x in num_list:
    if x > 45:
       #print("over 45")
       pass #comment out pass and remove comment from above print statement to see for loop results
    else:
       #print("under 45")
       pass #comment out pass and remove comment from above print statement to see for loop results
...
for position,y in enumerate(num_list):
    count += 1
    if y == 36:
      print("number found at index {}".format(position))
      break
...
#It retuns tuples with the index and corresponding value from the iterable
#Example:
